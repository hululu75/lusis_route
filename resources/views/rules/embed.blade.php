...
<body>
    <div class="container-fluid p-3">
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <code class="small">{{ $rule->class }}</code>
                        </td>
                        <td>
                        ...
                        <td>
                            @if($rule->delta)
                                <small>{{ $rule->delta->name }}</small>
                            @else
                                <span class="text-muted">-</span>
                            @endif
                        </td>
                        <td>
                            <span class="badge bg-primary">{{ $rule->routes_count ?? 0 }}</span>
                        </td>
                        <td>
        ...
        <div class="text-center py-5">
            ...
            <p class="text-muted">Create a rule using the modal form</p>
        </div>
        @endif
    </div>
</body>
